...
SNOWFLAKE_USER = "pradeep"
SNOWFLAKE_PASSWORD = "Sankojupradeep@123"
SNOWFLAKE_ACCOUNT = "nz22100.ap-southeast-1"
SNOWFLAKE_WAREHOUSE = "COMPUTE_WH"
SNOWFLAKE_DB = "stock_market"
...
def load_to_snowflake(**kwargs):
    ...
    for f in local_files:
        cur.execute(f"PUT file://{f} @%bronze")
